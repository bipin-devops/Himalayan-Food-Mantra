...
@section('content')
    ...
    <div id="page-title">
        <h2 style="display:inline-block">{{('Edit Product')}}</h2>
    </div>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            {!!Form::model($data,['method'=>'PUT','url'=>'system/product/update/'.$data->id, 'class'=>'form-horizontal bordered-row','enctype'=>'multipart/form-data'])!!}

            <div class="form-group" style="border-top: 0px;">
                <label class="col-sm-3 control-label require">{{('Category')}}</label>
                <div class="col-sm-6">
                    {!! Form::select('category_id',$category,$data->category_id,['class'=>'form-control select2','placeholder'=>'Select category','required'=>'required']) !!}
                </div>
            </div>
            <div class="form-group" style="border-top: 0px;">
            ...
            <div class="form-group" style="border-top: 0px;">
                ...
                <div class="col-sm-6">
                    <input type="text" name="product_ingredients" id="" placeholder="" required="required" class="form-control"
                           value="{{$data->product_ingredients}}">
                </div>
            </div>
            <div class="form-group" style="border-top: 0px;">
                <label class="col-sm-3 control-label ">{{('Short Description')}}</label>
                <div class="col-sm-6">
                    {{ Form::textarea('short_description',null,['class'=>' ','rows'=>'5','cols'=>'71','placeholder'=>'']) }}
                </div>
            </div>
